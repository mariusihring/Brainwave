...
export default function SemesterModuleStep() {
  const formData = useSemesterStepper()
    ...
    const createModuleMutation = useMutation({
        ...
        mutationFn: () => execute(CREATE_MODULE_MUTATION, {input: {
    ...
    const handleSave = () => {
        ...
        toast.promise(createModuleMutation.mutateAsync(), {
            ...
            success: (data) => {
                const mod: Module = {
                    ects: data.createModule.ects, id: data.createModule.id, name: data.createModule.name, startSemester: formData.created_semester_id as string
                }
    ...
    const handleCreateNewModule = () => {
     const module: Module =  {
         ects: 0, id: "some stuff", name: "New Module", startSemester: formData.created_semester_id as string
     }
     setNewModule(module)
    }
  return (
      <div className="space-y-4">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
                              ...
                              <div className="space-y-4">
                                  <div className="flex justify-between items-center">
                                      ...
                                      {isEditing ? (
                                          ...
                                          <span
                                              className="text-sm font-semibold bg-primary text-primary-foreground px-2 py-1 rounded-full">
                {newModule.ects} ECTS
              </span>
                                      )}
                                      {!isEditing && (
              ...
              {formData.modules.length > 0 && formData.modules.map((module, index) => (
              ...
              <Button className="col-span-4" onClick={handleCreateNewModule}>Add Module</Button>
          </div>
